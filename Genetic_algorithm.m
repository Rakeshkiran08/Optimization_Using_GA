%% Code for binary-coded GA with Roulette-wheel reproduction scheme, two point crossover and bit-wise mutation
%%  NOTE : Even though the code is written for general number of varables while changing the value of n
%%         appropriate changes to be made in 'objfunc.m' and plotting of optimal solution
...
Xmin = 0;
Gn_max = 70;                 %% maximum number of generations
...
%% plotting average fittness vs generations
F1 = figure
x = [1:Gn_max];
plot(x,avg_fit,'r-');
xlabel('Number of generations');
ylabel('Average fittness value');
title('AVERAGE FITNESS VALUE VS NUMBER OF GENERATIONS');
